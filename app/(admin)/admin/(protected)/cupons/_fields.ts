...
export const FIELDS: Field[] = [
  ...
  { key: "conditions", label: "Condições de uso", type: "textarea", placeholder: "Ex: Válido para passeios acima de R$100. Não cumulativo." },
  { key: "rules", label: "Regras e restrições", type: "textarea", placeholder: "Ex: Limite de 1 uso por CPF." },
